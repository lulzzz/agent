...
LDFLAGS=-ldflags "-r /snap/${SNAP_NAME}/current/lib/:/snap/core/current/lib/x86_64-linux-gnu/ -w -s -X main.version=${VERSION} -X github.com/subutai-io/agent/config.version=${VERSION}"
